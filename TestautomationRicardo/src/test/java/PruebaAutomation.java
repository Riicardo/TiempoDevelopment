...
public class PruebaAutomation {
	...
	By Contraseña1 = By.name("password");
	By Contraseña2 = By.name("confirmPassword");
	...
	public void RegistroUsuario() throws InterruptedException {
		...
		driver.findElement(Direccion2).sendKeys("Ciudad de los niños");		
		...
		driver.findElement(Contraseña1).sendKeys("prueba123");		
		driver.findElement(Contraseña2).sendKeys("prueba123");		
